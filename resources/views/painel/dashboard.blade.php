...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>Devolve-ME! - Painel de controle</title>
    ...
    <link href="{{ url('painel/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css')}}" rel="stylesheet"/>
  ...
  <body class="nav-md">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ url('painel/production/images/img.jpg') }}" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="{{ url('painel/production/images/img.jpg') }}" alt="">John Doe
                    </a>
   ...
   <script src="{{url('painel/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    ...
    <!-- jQuery custom content scroller -->
    <script src="{{ url('painel/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>
